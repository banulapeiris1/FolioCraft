...
export function FolioCraftLogo({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
    ...
    >
      ...
      <path
        d="M9 10C9 8.89543 9.89543 8 11 8H21C22.1046 8 23 8.89543 23 10V13C23 14.1046 22.1046 15 21 15H11C9.89543 15 9 14.1046 9 13V10Z"
        fill="white"
        fillOpacity="0.9"
      />
      <path
        d="M9 16.5C9 15.6716 9.67157 15 10.5 15H19.5C20.3284 15 21 15.6716 21 16.5V18.5C21 19.3284 20.3284 20 19.5 20H10.5C9.67157 20 9 19.3284 9 18.5V16.5Z"
        fill="white"
        fillOpacity="0.65"
      />
      <path
        d="M9 22C9 21.4477 9.44772 21 10 21H16C16.5523 21 17 21.4477 17 22V23C17 23.5523 16.5523 24 16 24H10C9.44772 24 9 23.5523 9 23V22Z"
        fill="white"
        fillOpacity="0.4"
      />
    </svg>
...
export function LayoutTemplateIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
